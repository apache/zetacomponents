 ...
 * @access private
 */
class ezcImageGdHandler extends ezcImageMethodcallHandler
{
    /**
    ...
    /**
     * Creates the GD filter and returns it.
     *
     * @return ezcImageGdFilters The filters object.
     */
    protected function createFilter()
    {
        if ( !class_exists( 'ezcImageGdFilters' ) )
        {
            // If this code is reached we have a bug in this component.
            throw new Exception( "Filter class not found for filter <{$this->name}>. Must be named <ezcImageGdFilters>" );
        }
        return new ezcImageGdFilters( $this );
    }
