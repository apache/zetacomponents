...
class ezcTemplateRequireOnceAstNode extends ezcTemplateStatementAstNode
{
    ...
    /**
     * @inheritdocs
     * Calls visitRequireOnceControl() of the ezcTemplateBasicAstNodeVisitor interface.
    ...
    public function accept( ezcTemplateAstNodeVisitor $visitor )
    {
        ...
        {
            throw new Exception( "Require_once control element does not have the \$expression variable set." );
        }
        $visitor->visitRequireOnceControl( $this );
    }
}
?>
