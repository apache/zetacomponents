...
class ezcTemplateIncludeAstNode extends ezcTemplateStatementAstNode
{
    ...
    /**
     * @inheritdocs
     * Calls visitIncludeControl() of the ezcTemplateBasicAstNodeVisitor interface.
    ...
    public function accept( ezcTemplateAstNodeVisitor $visitor )
    {
        ...
        {
            throw new Exception( "Include control element does not have the \$expression variable set." );
        }
        $visitor->visitIncludeControl( $this );
    }
}
?>
