...
class ezcConfigurationManagerTest extends ezcTestCase
{
    public function testInit()
    {
        ...
        $this->assertPrivatePropertySame( $config, 'readerClass', 'ezcConfigurationIniReader' );
    ...
    {
        $config = ezcConfigurationManager::getInstance();
        $config->init( 'ezcConfigurationIniReader', 'Configuration/trunk/tests/files', array() );
