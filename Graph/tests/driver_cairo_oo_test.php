 ...
 * @subpackage Tests
 */
class ezcGraphCairoOODriverTest extends ezcTestImageCase
{
    protected $driver;
    ...
    public function testGetResource()
    {
        ...
        $this->assertTrue( $resource['surface'] instanceof CairoImageSurface );
        $this->assertTrue( $resource['context'] instanceof CairoContext );
    }
