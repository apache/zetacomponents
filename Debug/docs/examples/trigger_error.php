...
Log::getInstance()->log("Added new user: $user", SUCCES_AUDIT, "paynet", "users");

Log::getInstance()->log("Couldn't delete user: $user", FAILED_AUDIT, "paynet", "users");
