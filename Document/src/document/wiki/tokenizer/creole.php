    ...
    public function __construct()
    {
        $this->tokens = array(
            ...
            ezcDocumentWikiToken::LINK_END =>
                '(\\A(?P<value>\\]\\]))',
            ezcDocumentWikiToken::LINK_SEPARATOR =>
            ...
            ezcDocumentWikiToken::TEXT_LINE =>
                ...
                // '(\\A(?P<match>(?P<value>(?:[A-Z]?[^A-Z' . self::TEXT_END_CHARS . ']+' . self::WHITESPACE_CHARS . '+)*[A-Z]?[^A-Z' . self::TEXT_END_CHARS . ']+))(?:[' . self::TEXT_END_CHARS . ']|$))',
