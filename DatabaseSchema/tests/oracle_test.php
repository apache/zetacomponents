 ...
 * @subpackage Tests
 */
class ezcDatabaseSchemaOracleTest extends ezcTestCase
{
        ...
        $tables = array(
            ...
            'bugdb_comments' => new ezcDbSchemaTable(
                array (
                    ...
                    'commentary' => new ezcDbSchemaField( 'text', 1000, true ),
                    'email' => new ezcDbSchemaField( 'text', 32 ),
                ),
                array (
                    'commentary' => new ezcDbSchemaIndex( array ( 'commentary' => new ezcDbSchemaIndexField() ) ),
                )
            ),
        );
        return $tables;
    ...
    public function testSimpleOracle()
    {
    ...
    public function testXmlOracleRoundTrip()
    {
    ...
    public function testXmlOracleInternal1()
    {
        $fileNameOrig = realpath( $this->testFilesDir . 'webbuilder.schema.xml' );
        $schema = ezcDbSchema::createFromFile( 'xml', $fileNameOrig );
    ...
    public function testXmlOracleInternal2()
    {
        $fileNameOrig = realpath( $this->testFilesDir . 'webbuilder.schema.xml' );
        $schema = ezcDbSchema::createFromFile( 'xml', $fileNameOrig );
    ...
    public function testXmlOracleInternal3()
    {
        $fileNameOrig = realpath( $this->testFilesDir . 'webbuilder.schema.xml' );
        $schema = ezcDbSchema::createFromFile( 'xml', $fileNameOrig );
    ...
    public function testXmlOracleInternal4()
    {
        $fileNameOrig = realpath( $this->testFilesDir . 'webbuilder.schema.xml' );
        $schema = ezcDbSchema::createFromFile( 'xml', $fileNameOrig );
    ...
    public function testTwoTablesPrimaryKey()
    {
        ...
        $sql = file_get_contents( $this->testFilesDir . 'bug8900_oracle.sql' );
