 ...
 * @subpackage Tests
 */
class ezcDatabaseSchemaPgSqlDiffTest extends ezcTestCase
{
    ...
    public function testWrite1()
    {
        ...
        $expected = array (
            ...
            3 => 'ALTER TABLE bugdb_change ALTER integerfield3 TYPE varchar(64)',
    ...
    public function testMysqlTwoTablesPrimaryKey()
    {
        ...
        $sql = file_get_contents( $this->testFilesDir . 'bug8900-diff_pgsql.sql' );
