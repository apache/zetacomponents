...
EOT;
    ...
    public function testStrlenIconv()
    {
        if ( !ezcBaseFeatures::hasExtensionSupport( 'iconv' ) )
        {
            $this->markTestSkipped( "Extension 'iconv' not found." );
        }
    ...
    public function testStrlenMb()
    {
        if ( ezcBaseFeatures::hasExtensionSupport( 'iconv' ) )
        {
            $this->markTestSkipped( "Extension 'iconv' found. Will therefore not fallback to mb_strlen()." );
        }
        if ( !ezcBaseFeatures::hasExtensionSupport( 'mbstring' ) )
        {
            $this->markTestSkipped( "Extension 'mbstring' not found." );
        }
    ...
    public function testStrlenFallback()
    {
        if ( ezcBaseFeatures::hasExtensionSupport( 'iconv' ) )
        {
            $this->markTestSkipped( "Extension 'iconv' found. Will therefore not fallback to mb_strlen()." );
        ...
        if ( ezcBaseFeatures::hasExtensionSupport( 'mbstring' ) )
        {
            $this->markTestSkipped( "Extension 'mbstring' found. Will therefore not fallback to strlen()." );
        }
