 ...
 */
class ezcMockLessThanConstraint implements ezcMockConstraint
{
    /**
     * The constraint value which all other values must be less than.
     */
    private $value;
    ...
    public function generateDescription()
    {
        ...
        return "is less than <" . $type  . var_export( $this->value, true ) . ">";
    }
