<?php
/**
 * File containing the ezcWebdavLockHeadRequestResponseHandler class.
 *
 * @package Webdav
 * @version //autogentag//
 ...
 */
/**
 * Handler class for the HEAD request.
 * 
 * @package Webdav
 * @version //autogen//
 *
 * @access private
 */
class ezcWebdavLockHeadRequestResponseHandler extends ezcWebdavLockRequestResponseHandler
{
    /**
