...
class ezcParamValuesTest extends ezcTestCase
{
    ...
    public function testBooleanParamForce()
    {
        ...
        $query
            ...
            ->set( 
                $this->boolColumn,
                $query->bindValue( true, PDO::PARAM_BOOL ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testBooleanParamForceBroken()
    {
        ...
        $query
            ...
            ->set( 
                $this->boolColumn,
                $query->bindValue( 'some string', PDO::PARAM_BOOL ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testIntegerParamForce()
    {
        ...
        $query
            ...
            ->set( 
                $this->intColumn,
                $query->bindValue( 42, PDO::PARAM_INT ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testIntegerParamForceBroken()
    {
        ...
        $query
            ...
            ->set( 
                $this->intColumn,
                $query->bindValue( '42 strings', PDO::PARAM_INT ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testStringParamForce()
    {
        ...
        $query
            ...
            ->set( 
                $this->strColumn,
                $query->bindValue( 'some string', PDO::PARAM_INT ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testStringParamForceBroken()
    {
        ...
        $query
            ...
            ->set( 
                $this->strColumn,
                $query->bindValue( true, PDO::PARAM_INT ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testClobParamForce()
    {
        ...
        $query
            ...
            ->set( 
                $this->clobColumn,
                $query->bindValue( $this->clob, PDO::PARAM_LOB ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testClobParamForceBroken()
    {
        ...
        $query
            ...
            ->set( 
                $this->clobColumn,
                $query->bindValue( 42, PDO::PARAM_LOB ) 
            );
        $query->prepare()->execute();
    }
    ...
    public function testBlobParamForce()
    {
        ...
        $query
            ...
            ->set( 
                $this->blobColumn,
                $query->bindValue( $this->blob, PDO::PARAM_LOB ) 
            );
        $query->prepare()->execute();
    }
